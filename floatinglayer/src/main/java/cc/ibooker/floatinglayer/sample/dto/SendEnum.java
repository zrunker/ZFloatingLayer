...
public enum SendEnum {
    SEND_RIGHT_TO_LEFT_ONE(CombinationEnum.COMBINATION_RIGHT_TO_LEFT_ONE, ViewType.VIEW_RIGHT_TO_LEFT_1),
    SEND_SHOW_TO_HIDE_ONE(CombinationEnum.COMBINATION_SHOW_TO_HIDE_ONE, ViewType.VIEW_SHOW_TO_HIDE_1);
